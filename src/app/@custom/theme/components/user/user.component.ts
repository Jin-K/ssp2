...
import { NbComponentSize, NbComponentStatus, NbBadgePosition, NbComponentShape } from '@nebular/theme';
 ...
 *
 * ```ts
 *   <ssp-user name="John Doe" title="Engineer"></ssp-user>
 * ```
 *
 * ### Installation
 *
 * Import `UserModule` to your feature module.
 * ```ts
 * @NgModule({
 *   imports: [
 *     // ...
