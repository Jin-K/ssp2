...
import { NbAuthStrategy, NbAuthStrategyClass, NbPasswordAuthStrategyOptions, passwordStrategyOptions, NbAuthResult, NbAuthIllegalTokenError } from '@nebular/auth';

@Injectable()
export class JwtAuthStrategy extends NbAuthStrategy {
  ...
  static setup(options: NbPasswordAuthStrategyOptions): [NbAuthStrategyClass, NbPasswordAuthStrategyOptions] {
    return [JwtAuthStrategy, options];
  }
  ...
  authenticate(data?: any): Observable<NbAuthResult> {
    ...
    return this.http.request(method, url, {body: newData, observe: 'response'})
      .pipe(
        map((res) => {
          if (this.getOption(`${module}.alwaysFail`)) {
            throw this.createFailResponse(newData);
          }
          return res;
        }),
        map((res) => {
